...
function Navbar() {
  ...
  const [stickty, setSticky] = useState(false);
  useEffect(() => {
    const handleScroll = () => {
      if (window.scrollY > 0) {
        setSticky(true);
  ...
  return (
    <div
      className={` max-w-screen-2xl container mx-auto md:px-16 px-4 dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 z-50 ${
        stickty
